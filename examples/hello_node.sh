...
if ! command -v fractal >/dev/null 2>&1; then
    echo "Error: fractal is not on PATH -- install it first (see the README's Installation section)" >&2
    exit 1
fi
